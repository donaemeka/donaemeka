...
## About Me
I am a DevOps & Cloud Engineer with a background in IT support, focused on designing and automating scalable cloud infrastructure.
...
Deployed a scalable 3-tier microservices application on AWS EKS with CI/CD automation  

**AWS Auto Scaling Web Application**  
Designed and implemented a highly available multi-AZ infrastructure using Terraform, Application Load Balancer, and Auto Scaling  

**DevOps Monitoring Solution**  
Implemented infrastructure provisioning, configuration automation, and monitoring using Terraform, Ansible, Prometheus, and Grafana  
